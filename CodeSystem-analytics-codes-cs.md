# AnalyticsCodesCs CodeSystem - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/CodeSystem/analytics-codes-cs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:AnalyticsCodesCS |

 
Local RESQ stroke registry CodeSystem generated from enum_models.py for system http://qualityregistry.org/CodeSystem/analytics-codes-cs. 
