# ThrombectomyComplications ValueSet - RESQ Stroke Registry Implementation Guide v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ThrombectomyComplications ValueSet**

## ValueSet: ThrombectomyComplications ValueSet 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/ValueSet/thrombectomy-complications-vs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:ThrombectomyComplicationsVS |
...
```json
{
  ...
  "compose" : {
    ...
    {
      "system" : "http://qualityregistry.org/CodeSystem/thrombectomy-complications-cs",
      "concept" : [{
        "code" : "other",
