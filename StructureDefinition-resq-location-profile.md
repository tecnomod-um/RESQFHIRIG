# RESQ Location Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/resq-location-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:RESQLocationProfile |
...
Provides a coded location/service container for stroke pathway data elements that are exchanged as Location resources. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-resq-location-profile.json)
