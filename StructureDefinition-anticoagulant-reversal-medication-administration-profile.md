...
| Active as of 2026-07-01 | *Computable Name*:AnticoagulantReversalMedicationAdministrationProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://tecnomod-um.org/CodeSystem/not-medication-reason-cs"
      }
    },
    {
