...
* **ObservationMethods ValueSet**

## ValueSet: ObservationMethods ValueSet 

| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/ValueSet/observation-methods-vs | *Version*:1.0.0 |
| Active as of 2026-05-07 | *Computable Name*:ObservationMethodsVS |

 
Allowed coded values for ObservationMethods, generated from enum_models.py. 
