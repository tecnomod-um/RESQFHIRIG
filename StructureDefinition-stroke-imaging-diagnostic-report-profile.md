# Stroke Imaging DiagnosticReport Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/stroke-imaging-diagnostic-report-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeImagingDiagnosticReportProfile |

 
DiagnosticReport profile for brain, carotid and follow-up imaging reports in the stroke pathway. 

 
Aggregates imaging observations and coded conclusions so imaging evidence can be referenced from procedures and clinical findings. 
