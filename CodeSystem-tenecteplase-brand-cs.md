# TenecteplaseBrandCs CodeSystem - RESQ Stroke Registry Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TenecteplaseBrandCs CodeSystem**

## CodeSystem: TenecteplaseBrandCs CodeSystem 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/CodeSystem/tenecteplase-brand-cs | *Version*:1.0.0 |
| Active as of 2026-09-04 | *Computable Name*:TenecteplaseBrandCS |

 
Local RESQ stroke registry CodeSystem generated from enum_models.py for system http://qualityregistry.org/CodeSystem/tenecteplase-brand-cs. 

 This Code system is referenced in the content logical definition of the following value sets: 

* [TenecteplaseBrand ValueSet](ValueSet-tenecteplase-brand-vs.md)
