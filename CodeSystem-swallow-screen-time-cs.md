# SwallowScreenTimeCs CodeSystem - RESQ Stroke Registry Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SwallowScreenTimeCs CodeSystem**

## CodeSystem: SwallowScreenTimeCs CodeSystem 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/CodeSystem/swallow-screen-time-cs | *Version*:1.0.0 |
| Active as of 2026-08-31 | *Computable Name*:SwallowScreenTimeCS |

 
Local RESQ stroke registry CodeSystem generated from enum_models.py for system http://qualityregistry.org/CodeSystem/swallow-screen-time-cs. 
