# FunctionalScore ValueSet - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/ValueSet/functional-score-vs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:FunctionalScoreVS |
...
```json
{
  ...
  "compose" : {
    ...
    {
      "system" : "http://qualityregistry.org/CodeSystem/functional-score-cs",
      "concept" : [{
        "code" : "ICH-score",
