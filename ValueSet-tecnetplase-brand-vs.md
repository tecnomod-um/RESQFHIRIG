...
* **TecnetplaseBrand ValueSet**

## ValueSet: TecnetplaseBrand ValueSet 

| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/ValueSet/tecnetplase-brand-vs | *Version*:1.0.0 |
| Active as of 2026-05-07 | *Computable Name*:TecnetplaseBrandVS |

 
Allowed coded values for TecnetplaseBrand, generated from enum_models.py. 
