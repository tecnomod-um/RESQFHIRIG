# First hospital for the stroke episode - RESQ Stroke Registry Implementation Guide v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **First hospital for the stroke episode**

## Extension: First hospital for the stroke episode 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/first-hospital-ext | *Version*:1.1.0 |
| Draft as of 2026-09-23 | *Computable Name*:FirstHospitalExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-first-hospital-ext.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://qualityregistry.org/StructureDefinition/first-hospital-ext"
    },
    {
