...
| Draft as of 2026-05-07 | *Computable Name*:FirstHospitalExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/tecnomod.resq.stroke|current/StructureDefinition/first-hospital-ext)
