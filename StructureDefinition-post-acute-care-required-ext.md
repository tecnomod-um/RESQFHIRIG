# Post-acute care required - RESQ Stroke Registry Implementation Guide v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Post-acute care required**

## Extension: Post-acute care required 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/post-acute-care-required-ext | *Version*:1.1.0 |
| Draft as of 2026-09-23 | *Computable Name*:PostAcuteCareRequiredExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-post-acute-care-required-ext.json)
