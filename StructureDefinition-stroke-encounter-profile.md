# Stroke Encounter Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/stroke-encounter-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeEncounterProfile |
...
Acts as the central clinical context for diagnosis, observations, procedures, medication administrations and follow-up resources created for one stroke episode. 
