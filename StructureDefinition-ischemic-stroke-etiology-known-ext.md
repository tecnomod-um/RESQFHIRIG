...
* **Ischemic stroke etiology known/unknown coded state**

## Extension: Ischemic stroke etiology known/unknown coded state 

| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/StructureDefinition/ischemic-stroke-etiology-known-ext | *Version*:1.0.0 |
| Draft as of 2026-06-08 | *Computable Name*:IschemicStrokeEtiologyKnownExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-ischemic-stroke-etiology-known-ext.json)
