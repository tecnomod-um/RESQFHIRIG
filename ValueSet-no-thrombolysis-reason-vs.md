...
* **NoThrombolysisReason ValueSet**

## ValueSet: NoThrombolysisReason ValueSet 

| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/ValueSet/no-thrombolysis-reason-vs | *Version*:1.0.0 |
| Active as of 2026-05-07 | *Computable Name*:NoThrombolysisReasonVS |

 
Allowed coded values for NoThrombolysisReason, generated from enum_models.py. 
