# Discharge department or service - RESQ Stroke Registry Implementation Guide v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Discharge department or service**

## Extension: Discharge department or service 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/discharge-department-service-ext | *Version*:1.1.0 |
| Draft as of 2026-09-23 | *Computable Name*:DischargeDepartmentServiceExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-discharge-department-service-ext.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://qualityregistry.org/StructureDefinition/discharge-department-service-ext"
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://qualityregistry.org/ValueSet/discharge-facility-department-vs"
      }
    }]
  }
}
