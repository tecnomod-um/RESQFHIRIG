# Discharge facility type - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/discharge-facility-type-ext | *Version*:1.1.0 |
| Draft as of 2026-09-23 | *Computable Name*:DischargeFacilityTypeExt |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://qualityregistry.org/StructureDefinition/discharge-facility-type-ext"
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://qualityregistry.org/ValueSet/discharge-facility-type-vs"
      }
    }]
  }
}
