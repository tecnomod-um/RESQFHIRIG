...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://tecnomod-um.org/StructureDefinition/ischemic-stroke-etiology-known-ext']) &lt;= 1">extension with URL = 'http://tecnomod-um.org/StructureDefinition/ischemic-stroke-etiology-known-ext': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://tecnomod-um.org/StructureDefinition/hemorrhagic-stroke-bleeding-reason-ext']) &lt;= 1">extension with URL = 'http://tecnomod-um.org/StructureDefinition/hemorrhagic-stroke-bleeding-reason-ext': maximum cardinality of 'extension' is 1</sch:assert>
