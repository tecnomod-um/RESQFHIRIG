...
| Draft as of 2026-08-31 | *Computable Name*:InitialCareIntensityExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-initial-care-intensity-ext.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://qualityregistry.org/StructureDefinition/initial-care-intensity-ext"
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://qualityregistry.org/ValueSet/hospitalized-in-vs"
      }
    }]
  }
}
