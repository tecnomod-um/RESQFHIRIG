# SpecificFindingCs CodeSystem - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/CodeSystem/specific-finding-cs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:SpecificFindingCS |

 
Local RESQ stroke registry CodeSystem generated from enum_models.py for system http://qualityregistry.org/CodeSystem/specific-finding-cs. 
