# Three-Month Contact Mode Observation Profile - RESQ Stroke Registry Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Three-Month Contact Mode Observation Profile**

## Resource Profile: Three-Month Contact Mode Observation Profile 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/three-month-contact-mode-observation-profile | *Version*:1.0.0 |
| Active as of 2026-09-04 | *Computable Name*:ThreeMonthContactModeObservationProfile |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-three-month-contact-mode-observation-profile.json)
...
Other representations of profile: [CSV](StructureDefinition-three-month-contact-mode-observation-profile.csv), [Excel](StructureDefinition-three-month-contact-mode-observation-profile.xlsx), [Schematron](StructureDefinition-three-month-contact-mode-observation-profile.sch) 
