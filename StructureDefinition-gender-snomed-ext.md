...
* **Gender represented with SNOMED CT**
...
| Draft as of 2026-06-08 | *Computable Name*:GenderSnomedExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-gender-snomed-ext.json)
