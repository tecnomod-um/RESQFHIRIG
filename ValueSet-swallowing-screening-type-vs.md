...
| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/ValueSet/swallowing-screening-type-vs | *Version*:1.0.0 |
| Active as of 2026-05-07 | *Computable Name*:SwallowingScreeningTypeVS |

 
Allowed coded values for SwallowingScreeningType, generated from enum_models.py. 
