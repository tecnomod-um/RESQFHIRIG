...
* **Hemorrhagic stroke bleeding reason found coded state**

## Extension: Hemorrhagic stroke bleeding reason found coded state 

| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/StructureDefinition/hemorrhagic-stroke-bleeding-reason-found-ext | *Version*:1.0.0 |
| Draft as of 2026-06-08 | *Computable Name*:HemorrhagicStrokeBleedingReasonFoundExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-hemorrhagic-stroke-bleeding-reason-found-ext.json)
