...
* **NoThrombectomyReason ValueSet**

## ValueSet: NoThrombectomyReason ValueSet 

| | |
| :--- | :--- |
| *Official URL*:http://tecnomod-um.org/ValueSet/no-thrombectomy-reason-vs | *Version*:1.0.0 |
| Active as of 2026-05-07 | *Computable Name*:NoThrombectomyReasonVS |

 
Allowed coded values for NoThrombectomyReason, generated from enum_models.py. 
