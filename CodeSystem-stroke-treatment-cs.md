# StrokeTreatmentCs CodeSystem - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/CodeSystem/stroke-treatment-cs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeTreatmentCS |

 
Local RESQ stroke registry CodeSystem generated from enum_models.py for system http://qualityregistry.org/CodeSystem/stroke-treatment-cs. 

 This Code system is referenced in the content logical definition of the following value sets: 

* [StrokeTreatment ValueSet](ValueSet-stroke-treatment-vs.md)
