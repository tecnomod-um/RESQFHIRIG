# Artifacts Summary - RESQ Stroke Registry Implementation Guide v1.1.0
...
| [RESQ Stroke Discharge Patient Summary Composition](StructureDefinition-resq-stroke-discharge-composition.md) | Composition profile for the RESQ Stroke Discharge Patient Summary document. It assembles the patient, index stroke encounter and clinically relevant registry resources into the FHIR R5 document hierarchy generated by RESQ2FHIR and aligned with the Xt-EHR EHDSDischargeReport logical model. |
...
| [Stroke Hospital Discharge Summary](Composition-ExampleRESQStrokeDischargeComposition.md) |
