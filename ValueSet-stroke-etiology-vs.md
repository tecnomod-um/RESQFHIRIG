# StrokeEtiology ValueSet - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/ValueSet/stroke-etiology-vs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeEtiologyVS |
...
```json
{
  ...
  "compose" : {
    ...
    {
      "system" : "http://qualityregistry.org/CodeSystem/stroke-etiology-cs",
      "concept" : [{
