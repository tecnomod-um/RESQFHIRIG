# Patient Ventilated Observation Profile - RESQ Stroke Registry Implementation Guide v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Patient Ventilated Observation Profile**

## Resource Profile: Patient Ventilated Observation Profile 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/patient-ventilated-observation-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:PatientVentilatedObservationProfile |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-patient-ventilated-observation-profile.json)
...
Other representations of profile: [CSV](StructureDefinition-patient-ventilated-observation-profile.csv), [Excel](StructureDefinition-patient-ventilated-observation-profile.xlsx), [Schematron](StructureDefinition-patient-ventilated-observation-profile.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.extension:requiredPostAcuteCare",
      "path" : "Observation.extension",
