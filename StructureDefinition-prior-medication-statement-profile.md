# Prior MedicationStatement Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/prior-medication-statement-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:PriorMedicationStatementProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://qualityregistry.org/ValueSet/adherence-codes-vs"
      }
    }]
  }
}
