# Procedure timing context - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/procedure-timing-context-ext | *Version*:1.1.0 |
| Draft as of 2026-09-23 | *Computable Name*:ProcedureTimingContextExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-procedure-timing-context-ext.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://qualityregistry.org/StructureDefinition/procedure-timing-context-ext"
    },
    {
