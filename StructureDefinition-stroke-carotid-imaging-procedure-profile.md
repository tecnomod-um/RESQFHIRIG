# Stroke Carotid Imaging Procedure Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/stroke-carotid-imaging-procedure-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeCarotidImagingProcedureProfile |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-stroke-carotid-imaging-procedure-profile.json)
