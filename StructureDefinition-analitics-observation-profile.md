# Analytics Observation Profile - RESQ Stroke Registry Implementation Guide v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Analytics Observation Profile**

## Resource Profile: Analytics Observation Profile 

| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/analytics-observation-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:AnaliticsObservationProfile |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-analitics-observation-profile.json)
...
Other representations of profile: [CSV](StructureDefinition-analitics-observation-profile.csv), [Excel](StructureDefinition-analitics-observation-profile.xlsx), [Schematron](StructureDefinition-analitics-observation-profile.sch) 
