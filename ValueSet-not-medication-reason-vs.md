# NotMedicationReason ValueSet - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/ValueSet/not-medication-reason-vs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:NotMedicationReasonVS |
...
```json
{
  ...
  "compose" : {
    ...
    },
    {
      ...
      {
        "code" : "not-required",
        "display" : "Medication not required"
      },
      {
        "code" : "not-reported",
        "display" : "Reason for not taking medication not reported"
      }]
    }]
  }
}
