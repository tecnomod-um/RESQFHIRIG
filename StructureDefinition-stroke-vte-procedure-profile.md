# Stroke VTE Prophylaxis Procedure Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/stroke-vte-procedure-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeVTEProcedureProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://qualityregistry.org/ValueSet/vte-procedures-vs"
      }
    },
    {
