...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile StrokeMedicationAdministrationProfile
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationAdministration">
      ...
      <sch:assert test="count(f:extension[@url = 'http://tecnomod-um.org/StructureDefinition/assessment-timing-ext']) &gt;= 1">extension with URL = 'http://tecnomod-um.org/StructureDefinition/assessment-timing-ext': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationAdministration/f:reason</sch:title>
    <sch:rule context="f:MedicationAdministration/f:reason">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:concept) &lt;= 0">concept: maximum cardinality of 'concept' is 0</sch:assert>
