# Appointment Management Observation Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/appointment-management-observation-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:AppointmentManagementObservationProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://qualityregistry.org/ValueSet/management-appointment-vs"
      }
    }]
  }
}
