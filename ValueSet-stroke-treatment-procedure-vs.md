# PostStrokeProcedures ValueSet - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/ValueSet/stroke-treatment-procedure-vs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeTreatmentProcedureVS |
...
```json
{
  ...
  "version" : "1.1.0",
  "name" : "StrokeTreatmentProcedureVS",
  ...
  "compose" : {
    "include" : [{
      "valueSet" : ["http://qualityregistry.org/ValueSet/post-stroke-procedures-vs"]
    },
    {
      "valueSet" : ["http://qualityregistry.org/ValueSet/stroke-treatment-vs"]
    }]
  }
}
