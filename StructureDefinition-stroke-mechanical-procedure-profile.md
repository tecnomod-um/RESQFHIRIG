...
* **Stroke Reperfusion Procedure Profile**
...
| Active as of 2026-07-14 | *Computable Name*:StrokeMechanicalProcedureProfile |
...
Captures key acute reperfusion procedures and non-performance reasons for quality metrics. 

**Usages:**

* This Profile is not used by any profiles in this Specification

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-stroke-mechanical-procedure-profile.json)
