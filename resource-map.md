...
Use [Profiles](profiles.md) when you know the FHIR resource type. Use [Modeling Decisions](modeling.md) when you need to understand why a registry field was placed in a given resource. Use [Terminology](terminology.md) when a profile binds an element to a generated ValueSet.
