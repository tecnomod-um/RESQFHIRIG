...
The [RESQ Stroke Discharge Patient Summary Composition](StructureDefinition-resq-stroke-discharge-composition.html) is the document-level view of the stroke admission. It groups the same profiled resources used throughout the IG into clinically meaningful discharge sections, including hospital course, diagnostic summary, procedures, treatment timings, discharge details, discharge medications and follow-up plan.
