...
The [RESQ Stroke Discharge Patient Summary Composition](StructureDefinition-resq-stroke-discharge-composition.html) is the document organization layer for the stroke admission. It groups the same profiled resources used throughout the IG into the EHDS-aligned discharge document hierarchy generated by RESQ2FHIR.
