# Glasgow Coma Scale Observation Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/glasgow-coma-scale-observation-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:GlasgowComaScaleObservationProfile |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/RESQFHIRIG|current/StructureDefinition/StructureDefinition-glasgow-coma-scale-observation-profile.json)
...
```json
{
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://qualityregistry.org/StructureDefinition/functional-score-observation-profile",
