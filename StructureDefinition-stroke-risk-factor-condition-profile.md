# Stroke Risk Factor Condition Profile - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/StructureDefinition/stroke-risk-factor-condition-profile | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:StrokeRiskFactorConditionProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://qualityregistry.org/ValueSet/risk-factor-vs"
      }
    },
    {
