# MTiciScore ValueSet - RESQ Stroke Registry Implementation Guide v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://qualityregistry.org/ValueSet/mtici-score-vs | *Version*:1.1.0 |
| Active as of 2026-09-23 | *Computable Name*:MTiciScoreVS |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "http://qualityregistry.org/CodeSystem/mtici-score-cs",
      "concept" : [{
        "code" : "0",
